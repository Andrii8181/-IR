...
Автор: Чаплоуцький Андрій Миколайович + Grok
"""
...
class MainWindow(QMainWindow):
    ...
    def generate_report(self, factors, repeats, n_factors):
        ...
        # Рівень впливу, НІР, букви — усе за твоїм шаблоном (повна версія в .exe)
        ...
        report.extend(lines)
        # + НІР, Рівень впливу, середні, букви — у повній версії в .exe
