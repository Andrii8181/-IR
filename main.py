...
def build_table_block(headers, rows):
    """
    Build a tab-delimited table for inserting into Tk Text/ScrolledText.
    IMPORTANT: keep headers clean (no extra trailing spaces), because column alignment
    is controlled by tab stops (tabs_from_table_px).
    """
    def ccell(x):
